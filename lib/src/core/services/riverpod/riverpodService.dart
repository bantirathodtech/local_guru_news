...
//
// // Old location API - commented out, now using LocationProvider with 3 separate APIs
...
//
// // The Hive box stores user data post-login.
// final userIdProvider = Provider<String>((ref) {
//   final box = Hive.box<String>('user');
//   // Return the value for 'id' or fallback to '0'
//   return box.get('id') ?? '0';
// });
