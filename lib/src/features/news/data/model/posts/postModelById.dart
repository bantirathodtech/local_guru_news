...
class PostsModelByID {
  ...
  factory PostsModelByID.fromJson(Map<String, dynamic> json) {
  ...
  static List<String>? _normalizeMediaList(dynamic value) {
    ...
    return list.map(_normalizeImageUrl).whereType<String>().toList();
  }
  ...
  static String? _normalizeImageUrl(String? value) {
    ...
    final hasImageExtension =
        RegExp(r'\.(png|jpe?g|gif|webp|svg|bmp)$', caseSensitive: false)
            .hasMatch(sanitized.split('?').first);
